...
def time_to_military(s):
    ...
    if (hour == 12):              # Add 12 to PM values
        hour = 0
    if(suff == 'PM'):                           # Set midnight to 0
        hour += 12
...
def time_to_minutes(s):
    ...
    # Adjust hour to be correct.
    suff = s[pos2+1:]
    if (suff == 'AM' and hour == 12):                  # Add 12 to PM values
        hour = 0
    elif (suff == 'PM' and hour != 12): # Set midnight to 0
        hour += 12
